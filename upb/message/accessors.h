...
UPB_INLINE void upb_Message_GetField(const upb_Message* msg,
                                     const upb_MiniTableField* field,
...
UPB_API_INLINE bool upb_Message_GetBool(const upb_Message* msg,
  ...
  upb_Message_GetField(msg, field, def, &ret);
  return ret.bool_val;
}
